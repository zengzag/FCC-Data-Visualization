...
var GridSquare = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            "div",
            { className: "grid", id: "grid", style: { width: this.props.width, height: this.props.height } },
            gridSquare
        );
    }
});
...
function updateGrid() {
    //根据grid刷新地图
    ReactDOM.render(React.createElement(GridSquare, { grids: grid, width: gridWidth * 15 + 'px', height: gridHeight * 15 + 'px' }), document.getElementById('container'));
}
